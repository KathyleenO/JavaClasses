...
public class Recap {
	...
	public static void main(String[] args) {
		...
		Iterator<Entry<String, Integer>> myentry= entr.iterator();
		while(myentry.hasNext()) {
			Entry<String,Integer> printentry= myentry.next();
			System.out.println(printentry.getKey()+ " : " +printentry.getValue());
